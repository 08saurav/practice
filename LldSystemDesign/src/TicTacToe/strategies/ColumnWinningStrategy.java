...
public class ColumnWinningStrategy implements WinningStrategy{
    ...
    public boolean checkWinner(Move move, Board board) {
        ...
        System.out.println("Current column: " + currentCol.get(symbol)+" "+board.getSize());
        if (currentCol.get(symbol) == board.getSize()) {
            System.out.println("Winner Found in Column " + col + " with symbol: " + symbol.getSymbol());
            counts.clear();  // Reset for next game
            return true;
        }
