...
public class Game {
    ...
    public boolean validateMove(Move move){
        ...
        if(!board.getCells().get(row).get(col).getState().equals(CellState.EMPTY))
            return false;
...
//        Move finalMoveObject = new Move(cellToChange , currentPlayer);
        ...
        System.out.println(checkWinner(board,move)+" checking winner");
        if(checkWinner(board , move)){
            gameState = GameState.SUCCESS;
            winner = currentPlayer;
            System.out.println(gameState+" Winner is "+winner);
